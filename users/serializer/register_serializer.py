...
class UserRegistrationSerializer(serializers.Serializer):
    ...
    role_id = serializers.UUIDField(
        validators=[RegexValidator(
                regex=r'^[a-f0-9\-]{36}$', message='Role must be a valid UUID format.')],
        error_messages={
...
class UserUpdateSerializer(serializers.Serializer):
    ...
    date_of_birth = serializers.DateField(
        ...
        error_messages={
            'invalid': 'Enter a valid date for the date of birth.',
            'null': 'Date of birth cannot be null.',
            'blank': 'Date of birth field may not be blank.',
        }
    )
    ...
    #     """
    #     Validates whether the email already exists in the User model.
    #     """
